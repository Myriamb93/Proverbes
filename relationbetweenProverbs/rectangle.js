document.onload = (function(d3, saveAs, Blob, undefined){
  ...
  GraphCreator.prototype.removeSelectFromNode = function(){
    var thisGraph = this;
    thisGraph.rect.filter(function(cd){
  ...
  GraphCreator.prototype.svgMouseUp = function(){
    ...
    if (state.justScaleTransGraph) {
      ...
      var xycoords = d3.mouse(thisGraph.svgG.node()),
          d = {id: thisGraph.idct++, title: "Nouveau Proverbe", x: xycoords[0], y: xycoords[1]};
      thisGraph.nodes.push(d);
      thisGraph.updateGraph();
      // make title of text immediently editable
      var d3txt = thisGraph.changeTextOfNode(thisGraph.rect.filter(function(dval){
        return dval.id === d.id;
      }), d),
          txtNode = d3txt.node();
      thisGraph.selectElementContents(txtNode);
  ...
  GraphCreator.prototype.updateGraph = function(){
    ...
    paths.style('marker-end', 'url(#end-arrow)')
      ...
      .attr("d", function(d){
        return "M" + (d.source.x+20) + "," + (d.source.y+20) + "L" + (d.target.x+45) + "," + (d.target.y+45);
      });
    ...
    // add new nodes
    var newGs= thisGraph.rect.enter()
          .append("g");
